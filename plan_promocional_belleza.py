...
categorias['Si'] = categorias['Si'] + categorias['1.Si\r\n2.No'] + categorias['1.Si\r\n2.Si']
...
writter = pd.ExcelWriter('RepPromoBelleza.xlsx')
...
for cat in categorias_values:
    reporte_mot[reporte_mot['Categoría'] == cat].to_excel(writter, 'Resumen MOT', startrow=row + 1, index=False,
                                                          header=False)
